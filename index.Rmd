...
## Results
Before regressing the RL outcome on the VA variable, the bivariate relationship between these variables can be visualized with a scatter plot. 
